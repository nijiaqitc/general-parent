...
public class ImageUtil {
    ...
    public static void main(String[] args) {
        ...
        /*// 1-缩放图像：
        // 方法一：按比例缩放
    	Test3.scale("e:/abc.jpg", "e:/abc_scale.jpg", 2, true);//测试OK
        // 方法二：按高度和宽度缩放
    	Test3.scale2("e:/abc.jpg", "e:/abc_scale2.jpg", 500, 300, true);//测试OK

        // 2-切割图像：
        // 方法一：按指定起点坐标和宽高切割
    	Test3.cut("e:/abc.jpg", "e:/abc_cut.jpg", 0, 0, 400, 400 );//测试OK
        // 方法二：指定切片的行数和列数
    	Test3.cut2("e:/abc.jpg", "e:/", 2, 2 );//测试OK
        // 方法三：指定切片的宽度和高度
    	Test3.cut3("e:/abc.jpg", "e:/", 300, 300 );//测试OK

        // 3-图像类型转换：
    	Test3.convert("e:/abc.jpg", "GIF", "e:/abc_convert.gif");//测试OK

        // 4-彩色转黑白：
    	Test3.gray("e:/abc.jpg", "e:/abc_gray.jpg");//测试OK

        // 5-给图片添加文字水印：
        // 方法一：
    	Test3.pressText("我是水印文字","e:/abc.jpg","e:/abc_pressText.jpg","宋体",Font.BOLD,Color.white,80, 0, 0, 0.5f);//测试OK
        // 方法二：
    	Test3.pressText2("我也是水印文字", "e:/abc.jpg","e:/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0, 0.5f);//测试OK
