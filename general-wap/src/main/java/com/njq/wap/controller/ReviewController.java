...
public class ReviewController {
    ...
    public String reviewInfo(Model model,HttpServletRequest request) {
    ...
    @ResponseBody
    public StudyNotesVO getReviewDoc(Model model,HttpServletRequest request,Long reviewId,Long chunkId,String queryFlag) {
		StudyNotesVO vo = null; 
    	if(reviewId != null) {
