...
public class CnblogsController {
    ...
    public String login() {
		return yhWikiPageAnalysis.analysisPage("",null);
	}
	
	@RequestMapping("cgb")
    public String cgb() {
		cgblogsPageAnalysis.analysisPage("https://www.cnblogs.com/ceshi2016/mvc/blog/sidecolumn.aspx?blogApp=ceshi2016",null);
...
//		return cgblogsPageAnalysis.analysisPage("https://www.cnblogs.com/ceshi2016/category/1065679.html");
        model.addAttribute("doc", cgblogsPageAnalysis.analysisPage("https://www.cnblogs.com/Zachary-Fan/p/highcohesionlowcoupling.html",null));
        return "grab/view";
	}
}
