...
<body>
	...
	<div id="centerPlace">
		...
		<div id="rightContext">
			...
			<div id="csdialog" style="position: fixed;width: 550px;min-height: 350px;background-color: #fff;top: 130px;border: 1px solid #888;right: -560px;z-index: 99999" align="center">
				<div style="width: 300px;margin-top: 30px;">
					...
					<div align="left" style="padding: 6px 0;">
					是否是特殊类别:<span>是<input type="radio" name="specalType" value="1" ></span>&nbsp;&nbsp;<span>否<input type="radio" name="specalType" value="0" checked="checked"></span>
					</div>
					<div align="left">
