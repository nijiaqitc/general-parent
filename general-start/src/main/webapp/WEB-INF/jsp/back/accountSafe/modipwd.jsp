...
<!-- 			<jsp:include page="${path}/left"></jsp:include> 
			...
			<div id="content" class="span10" >
				<div class="span3 smallstat box mobileHalf" style="width: 900px;height: 700px;">
					<div align="center" style="font-size: 30px;font-weight: bolder;margin-top: 30px;">登录密码</div>
					<div style="margin-top: 50px;">
						<div id="MyWizard" class="wizard">
							<ul class="steps">
								...
								<li data-target="#step2" style="padding-left: 120px;"><span class="badge" style="width: 120px;">密码修改</span></li>
								...
								<form class="form-horizontal">
									<fieldset>	
										<div class="control-group">
											<label class="control-label" for="input1" style="width: 280px;">新密码：</label>
											<div class="controls">
									  			<input type="password" id="input1" maxlength="16" style="width: 350px;margin-left: -210px;">
											</div>
								  		</div>
								  		<div class="control-group" style="margin-top: 30px;">
											<label class="control-label" for="input2" style="width: 280px;">重复密码：</label>
											<div class="controls">
									  			<input type="password" id="input2" maxlength="16" style="width: 350px;margin-left: -210px;">
											</div>
								  		</div>
		...
		function toNext(index){
			if(index==1){
				...
				if($("#input1").val().length<8){
					$("#pwdError").html("*密码长度最小为8!");
					$("#pwdError").show();
					return 
				}
				if($("#input1").val().length>16){
					$("#pwdError").html("*密码长度最大为16!");
					$("#pwdError").show();
					return 
				}
				if($("#input1").val()!=$("#input2").val()){
					$("#pwdError").html("*两次输入密码不相同!");
					$("#pwdError").show();
					return
				}
				
				$.ajax({
					url:"${path}/admin/accountSafe/upUserPwd",
					data:{
						newPwd:$("#input1").val()
					},
					type:"post",
