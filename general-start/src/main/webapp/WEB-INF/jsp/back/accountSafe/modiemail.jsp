	...
	<script type="text/javascript">
		...
		function toNext(index){
			if(index==1){
				...
				if(!filter.test($("#input1").val())){
					$("#pwdError").html("*邮箱号码错误！");
					$("#pwdError").show();
					return
				}
				$.ajax({
...
<!-- 			<jsp:include page="${basePath}/left"></jsp:include> 
			...
			<div id="content" class="span10" >
				<div class="span3 smallstat box mobileHalf" style="width: 900px;height: 700px;">
					<div align="center" style="font-size: 30px;font-weight: bolder;margin-top: 30px;">邮箱地址</div>
					<div style="margin-top: 50px;">
						<div id="MyWizard" class="wizard">
							<ul class="steps">
								...
								<li data-target="#step2" style="padding-left: 120px;"><span class="badge" style="width: 120px;">替换邮箱</span></li>
								...
								<form class="form-horizontal">
									<fieldset>	
										<div class="control-group">
											<label class="control-label" for="input1" style="width: 280px;">邮箱号：</label>
											<div class="controls">
									  			<input type="text" id="input1" maxlength="32" style="width: 350px;margin-left: -210px;">
											</div>
								  		</div>
								  		<div id="pwdError" style="font-size: 12px;color: red;margin-left: -200px;display: none;"></div>
