...
<body>
    ...
    <div class="contextArea" align="center">
    	<div style="font-size: 12px;background-color: #c0d9ef;overflow: auto;">
    		<div style="margin-left: 10px;float: left;">当前位置：加密工具>>encrypt加密</div>
    	</div>
    ...
    <script src="${resPath }/zxgj/js/tools/encrypt.js" type="text/javascript"></script>
