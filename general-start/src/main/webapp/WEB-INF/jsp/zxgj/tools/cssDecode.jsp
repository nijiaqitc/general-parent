...
<body>
    ...
    <div class="contextArea" align="center">
    	<div style="font-size: 12px;background-color: #c0d9ef;overflow: auto;">
    		<div style="margin-left: 10px;float: left;">当前位置：加密工具>>css格式化</div>
    	</div>
    ...
    <script src="${resPath }/zxgj/js/tools/cssDecode.js" type="text/javascript"></script>
    <script type="text/javascript">
    	function decode(){
    		var css=CSSPacker["format"]($("#text1").val());
    		$("#text2").val(css);
    	}
