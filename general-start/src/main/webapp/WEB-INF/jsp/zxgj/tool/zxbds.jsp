		...
		<div class="panel panel-default" style="margin-bottom: 0px;">
		  <div class="panel-body" >
		  	<div style="margin-left: 10px;">
				<ul class="leftCommUl" style="text-align: left;">
	...
	<div style="float:left;width:58%;margin-left: 70px;height:100%;">
		<div class="panel panel-default" style="margin-bottom: 0px;height:100%;">
		  <div class="panel-body" style="height:100%;">
		    ...
		    <textarea style="width:100%;height:68%;border: 0;outline:none;margin-top: 24px;min-height: 380px;" id="area2"  placeholder="加密后内容展示区域" ></textarea>
		  </div>
		</div>
	</div>
