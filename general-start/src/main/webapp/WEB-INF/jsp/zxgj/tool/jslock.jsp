...
<body>
		  ...
		  <div class="panel-body" style="height:100%;">
		  	<div style="height: 34px;">
			  	<div style="float:left;">
				    ...
				    <button type="button" class="btn btn-danger" onclick="runcode()">运行</button>
			  	</div>
		  	</div>
	...
	<script src="${resPath }/zxgj/js/tools/jslock.js" type="text/javascript"></script>
	<script type="text/javascript">
		function jiami(){
    		if(!$("#area1").val()){
    			return
    		}
    		var lockst=encode($("#area1").val());
    		$("#area2").val(lockst);
    	}
    	function jiemi(){
    		if(!$("#area2").val()){
