			...
			"<div class='adocDiv2'>"+
				...
				"<div class='adocDiv5'><span>"+data.docList[i].userName+"</span>";
		  		if(data.typeName!=null){
		  			str+="<span class='aspan1'>类型:"+data.typeName+"</span>"
		  		}
			str+="</div><div class='adocDiv6'><a href="+jspath+"/wap/docView/"+data.docList[i].id+">"+data.docList[i].title+"</a></div>"+
			"</div>"+
			"<div class='adocDiv7'>"+
				"<div class='adocDiv8'><a href="+jspath+"/wap/docView/"+data.docList[i].id+">"+data.docList[i].formatGeneral100+"</a></div>"+
				"<div align='right' class='adocDiv9'>"+data.docList[i].formatCreatedDate+"&nbsp;&nbsp;浏览("+data.docList[i].readnums+")</div>"+
			"</div>"+
		"</div>";
