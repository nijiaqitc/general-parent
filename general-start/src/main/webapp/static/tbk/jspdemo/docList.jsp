...
<body>
    ...
    <div align="center" style="height: 620px;clear: both;">
    	<div align="center" style="width: 940px;">
	    	<div align="center" style="height: 300px;width: 250px;float: left;display: inline;">
	    		<div class="menu-box" style="height: 300px;width: 250px;display: none;" >
	    			可以放搜索排行 或者 其他人还搜  可以放相关文档（暂时不知道怎么算相关文档）
	    		</div>
	    		<div align="left" class="menu-box" style="height: 600px;width: 250px;margin-top: 20px;" >
	    			<div style="margin-left: 20px;padding-top: 20px;">
		    			<div style="font-size: 18px;font-weight: bold;margin-bottom: 8px;">滴水成河、粒米成箩</div>
		    			<div>全部文章(1000)</div>
		    			<div>全部文章(1000)</div>
		    			<div>全部文章(1000)</div>
		    			<div>全部文章(1000)</div>
