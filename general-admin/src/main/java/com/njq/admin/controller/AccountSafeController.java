...
public class AccountSafeController {
	...
	public @ResponseBody Map<String, Object> sendCode(Model model, String type) {
	...
	public @ResponseBody Map<String, Object> checkCode(Model model, @RequestParam(required = true) String code,
	...
	public @ResponseBody Map<String, Object> upUserPwd(@RequestParam String newPwd, Model model) {
		Map<String, Object> map = new HashMap<String, Object>();
	...
	public @ResponseBody Map<String, Object> upTel(@RequestParam String newTel, Model model) {
		Map<String, Object> map = new HashMap<String, Object>();
		String coke = CookieUtil.getCookieVaule("modiCodeFlag");
		if ("true".equals(coke)) {
	...
	public @ResponseBody Map<String, Object> upEmail(@RequestParam String newEmail, Model model) {
		Map<String, Object> map = new HashMap<String, Object>();
		String coke = CookieUtil.getCookieVaule("modiCodeFlag");
		if ("true".equals(coke)) {
	...
	public @ResponseBody Map<String, Object> upUserPic(@RequestParam String picPlace, Model model,
			HttpSession session) {
		Map<String, Object> map = new HashMap<String, Object>();
