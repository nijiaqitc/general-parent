...
public class LoginController {
	...
	public @ResponseBody Map<String, Object> register(@Valid BaseUser user, Errors errors) {
	...
	public @ResponseBody Map<String, Object> loginCheck(@RequestParam String account, @RequestParam String pwd,
	...
	public @ResponseBody Map<String, Object> loginOut(HttpSession session) {
		Map<String, Object> map = new HashMap<String, Object>();
		session.invalidate();
		MessageCommon.getSuccessMap(map);
		return map;
